...
ds = UbuntuCorpus(args.source, args.vocab, max_vocab, max_len, max_history, max_examples=max_examples, regen=args.regen)
# else:
...
with torch.no_grad():
    ...
    if args.val is not None:
        ...
        val_temp_dir = os.path.join(args.vocab, 'validation')
        ds = UbuntuCorpus(args.val, val_temp_dir, max_vocab, max_len, max_history, max_examples=None, regen=False)
