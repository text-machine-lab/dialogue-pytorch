...
try:
    ...
    if args.regen: alert.write('run_seq2seq: finished building datasets')
    ...
    if args.epochs > 0: alert.write('run_seq2seq: training finished')
    ...
    alert.write('run_seq2seq: exception!')
    raise
